...
Алгоритм представляет собой разделение матриц на блоки в соответствии с количеством блоков для последующего перемножения соответствующих блоков.

Предположим, что матрицы можно разделить на 4 блока, тогда процессы будут располагаться следующим образом:
